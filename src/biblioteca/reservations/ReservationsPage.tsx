...
const ReservationsPage: React.FC = () => {
      ...
      >
        <div className="flex justify-between items-start mb-4">
          <div className="flex-1">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">{reservation.name}</h3>
            <div className="flex flex-col gap-2">
              <p className="text-sm text-gray-600 m-0">📅 {reservation.date} a las {reservation.time}</p>
              <p className="text-sm text-gray-600 m-0">⏱️ Duración: {reservation.duration}</p>
              {reservation.notes && (
                <p className="text-sm text-gray-600 m-0">📝 {reservation.notes}</p>
              )}
            </div>
          </div>
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Reservar Espacios</h1>
        <p className="text-gray-600 m-0">Reserva cubículos y salas para estudiar o trabajar</p>
      </div>
      {/* Formulario */}
      ...
      {/* Reservas */}
      <div>
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Tus Reservas</h2>
