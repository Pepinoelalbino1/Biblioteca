...
const CatalogPage: React.FC = () => {
      ...
      >
        <div className="flex justify-between items-start mb-4">
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600 mb-2 flex items-center gap-2"><MapPin size={16} /> {library.location}</p>
            <p className="text-sm text-gray-600 m-0">{library.description}</p>
          </div>
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Catálogo de Bibliotecas</h1>
        <p className="text-gray-600 m-0">Explora todas las bibliotecas disponibles en nuestra red</p>
      </div>
